...
while True:
    ...
    if choiceTwo in ["left", "Left"]:
        ...
        print("You slowly open the Left Door, only to find it to be completely empty, you proceed to the Right Door; entering it.")
        time.sleep(3)
        break
...
print("In it, you find yourself standing amongst a long dark corridor")
time.sleep(2)
...
if myClass in ["knight", "Knight"]:
    ...
    time.sleep(3)
    print("You have found an Iron Shield as well as a worn Iron Mace!")
    time.sleep(2)
